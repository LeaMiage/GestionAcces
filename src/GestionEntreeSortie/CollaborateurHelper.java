...
public class CollaborateurHelper
{
    ...
    {
        a.insert_Streamable(new GestionEntreeSortie.CollaborateurHolder(t));
    }
    ...
    public static GestionEntreeSortie.Collaborateur extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof GestionEntreeSortie.CollaborateurHolder)
                    return ((GestionEntreeSortie.CollaborateurHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            GestionEntreeSortie.CollaborateurHolder h = new GestionEntreeSortie.CollaborateurHolder(read(a.create_input_stream()));
    ...
    private final static String _id = "IDL:GestionEntreeSortie/Collaborateur:1.0";
    ...
    {
        GestionEntreeSortie.Collaborateur new_one = new GestionEntreeSortie.Collaborateur();
